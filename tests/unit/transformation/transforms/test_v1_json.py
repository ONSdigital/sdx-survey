...
class TestIndex(unittest.TestCase):
    ...
    def test_get_filename(self):
        ...
        actual = transformer.get_file_name(Response(self.submission))
        expected = "007_006ac9dec25d4fb1.json"
        self.assertEqual(expected, actual)

    def test_get_bics_filename(self):
        transformer = V1JsonTransform()
        self.submission["survey_metadata"]["survey_id"] = "283"
        actual = transformer.get_file_name(Response(self.submission))
        expected = "006ac9de-c25d-4fb1-bc01-8369a0ca6d31.json"
        self.assertEqual(expected, actual)
